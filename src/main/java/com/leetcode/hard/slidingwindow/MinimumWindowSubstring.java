...
public class MinimumWindowSubstring {
    public static void main(String[] args) {
        System.out.println(minWindow("ADOCCCAAABBBBECODEBANC", "ABC"));
//        System.out.println(minWindow("A", ""));
        System.out.println(minWindow("abba", "aba"));
        System.out.println(minWindow("bbaa", "aba"));
    }

    public static String minWindow(String s, String t) {char[] s_array = s.toCharArray();
